...
@DatabaseTable(tableName = ConfigRowSet.TABLE_NAME)
public class ConfigRowSet implements IDatabaseTable {
    public static final String TABLE_NAME = "config_set";
    ...
    @DatabaseField(columnName = VALUE_FIELD_NAME, uniqueIndexName = FULL_KEY_INDEX_NAME)
    ...
    public ConfigRowSet(UUID module, String parameter, String value) {
        this.module = module;
