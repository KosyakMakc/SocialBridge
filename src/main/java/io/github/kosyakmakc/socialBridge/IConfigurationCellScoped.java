...
/**
 * Scoped configuration accessor for database-backed configuration.
 * Instance is scoped to a specific transaction, moduleId, and parameterName.
 * Values are cached within the transaction lifetime - guaranteed not dirty.
 * 
 ...
 */
public interface IConfigurationCellScoped {
    /**
